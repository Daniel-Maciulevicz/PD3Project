...
{
    public abstract class AttackStrategyBaseClass : IAttackStrategy
    {
        ...
        public abstract event EventHandler AttackStarted;
        ...
        public AttackStrategyBaseClass(Brawler context, BrawlerPresenter presenterContext)
        {
            Context = context;
